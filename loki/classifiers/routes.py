...
from loki.classifiers.forms import PredictForm, UploadClassifierForm
from loki.classifiers.utils import save_model, remove_model
...
@classifiers.route("/classifiers/predict",
                   methods=['POST', 'GET'])
@login_required
def predict():
    form = PredictForm()
